  ...
  return (
    <div className="text-light">
      <section
        ...
        data-testid="sponsors_list_Sponsors"
      >
        <div className="container">
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL PLATINUM PARTNERS</p>
          ...
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL PREMIUM PARTNERS</p>
            <div className="sponsors-logos">
              <img
                alt="New Muraba"
                className="sponsor-logo"
          ...
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL STRATEGIC PARTNERS</p>
            <div className="sponsors-logos">
              <img
                alt="Maestro"
                className="sponsor-logo"
          ...
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL MAIN PARTNERS</p>
            <div className="sponsors-logos">
              <img
                alt="Pepsi"
                className="sponsor-logo"
          ...
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL AIRLINE PARTNER</p>
            <div className="sponsors-logos">
              <img
                alt="Fly SUDIA"
                className="sponsor-logo"
          ...
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL SOCIAL MEDIA PARTNER</p>
            <div className="sponsors-logos">
              <img
                alt="Jaco"
                className="sponsor-logo"
          ...
          <div className="sponsors-group">
            <p className="sponsors-title">OFFICIAL CO PARTNERS</p>
            <div className="sponsors-logos">
              <img
                alt="SIRC"
                className="sponsor-logo"
